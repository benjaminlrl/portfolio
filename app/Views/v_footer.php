        ...
        <div class="grid grid--fit grid--xl g-4" id="grid__footer">
            <div class="grid__cell" id="footer__cell_1">
                ...
                <div class="cell__content cell__content--start">
                    <p class="text--xxs text--600 text--start text--white text--opacity-900">Étudiant à l'ISCB en BTS SIO SLAM, alternant pour le ministère des Armées / DRHAT. En recherche d'une alternance de 3 ans pour préparer mon diplôme d'ingénieur
                    </p>
                </div>
            </div>
            <div class="grid__cell" id="footer__cell_2">
                <div class="cell__header">
