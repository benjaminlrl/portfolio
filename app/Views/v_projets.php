...
$projets = [
        [
                ...
                "missions"=>[
                        ...
                        "mission2"=>[
                                ...
                                "taches"=>["Générer le bon code HTML par le CMS sans surcouche CSS de manière à ce que le template reste maintenable.",
        ...
        [
                "titre" => "Portfolio",
                "description" => "Portfolio développé par mes soins afin de mettre en avant mes compétences.",
                "description_detail"=>"RH-Terre est le site administratif de l'armée de Terre permettant à nos 180 000 militaires et réservistes de faciliter leurs démarches administratives (permissions, demandes de Bulletin Mensuel de Solde, déclaration de situations...).",
...
<section id="section__projets">
    ...
    <div class="section__container section__container--center">
        <?= form_open("", ["class" => "grid grid--l"]); ?>
        <?= form_fieldset('Filtrer les projets', ["class" => "fieldset--row g-2"]); ?>
        <?php
        $optionsCompetences = [
                ''  => 'Aucun filtre',
        ...
        $dataCompetences = [
                ...
                'class'=>'text--xs input--secondary p-0-4-rem'
        ...
        echo form_dropdown($dataCompetences, $optionsCompetences, '',["placeholder"=>"Compétences"]);
        echo form_dropdown($dataContexte, $optionsContexte, '',["placeholder"=>"Contexte"]);
        echo form_dropdown($dataOrdre, $optionsOrdre, '',["placeholder"=>"Ordre"]);
        ...
        <div class="card grid my-5-vh" id="card__projets">
            ...
            foreach ($projets as $projet) :
                ...
                <!-- Carte du projet (BUTTON pour accessibilité) -->
                <button type="button"
                ...
                <dialog class="dialog dialog--projet p-0" id="dialog__projet_<?= $index ?>" aria-modal="true" aria-labelledby="dialog_titre_<?= $index ?>">
                        <div class="card grid grid--full">
                            ...
                            <?php endif; ?>
                            <div class="grid grid--competences-projets g-1">
                                <?php foreach($projet["competences"] as $competence): ?>
                                    <div class="grid__cell p-2-1-vh">
                                        <div class="cell__content">
                                            <h5 class="text--s"><?= $competence["titre"]?></h5>
                                            <?php
        ...
        <button type="button" class="button button--tertiaire" id="button_plus_projets">Voir&nbsp;plus</button>
    </div>
</section>
